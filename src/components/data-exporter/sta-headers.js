...
export default {
    headers: headers,
    table: table,
    thing: _(headers).filter(header => header.entity === 'thing').value(),
    location: _(headers).filter(header => header.entity === 'location').value(),
    datastream: _(headers).filter(header => header.entity === 'datastream').value(),
    observedProperty: _(headers).filter(header => header.entity === 'observedProperty').value(),
    sensor: _(headers).filter(header => header.entity === 'sensor').value(),
    featureOfInterest: _(headers).filter(header => header.entity === 'featureOfInterest').value(),
    observation: _(headers).filter(header => header.entity === 'observation').value(),
    entityToPath: {
